...
public class CharacteristicOperationFragment extends Fragment {
    ...
    String TAG = "CharacteristicOperationFragment";
                                        ...
                                        public void onReadSuccess(final byte[] data) {
                                            runOnUiThread(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    Log.e(TAG, "Read success : " + HexUtil.formatHexString(data, true));
...
//                                            });
                                            ...
                                            runOnUiThread(new Runnable() {
                                                ...
                                                public void run() {
                                                    addText(txt, "write success, current: " + current
                                                            + " total: " + total
                                                            + " write data: " + new String(justWrite));
                                                }
                                            });
                                        }
                                        ...
                                        new BleNotifyCallback() {
                                            ...
                                            public void onNotifySuccess() {
                                                runOnUiThread(new Runnable() {
                                                    ...
                                                    public void run() {
                                                        ...
                                                        Log.e(TAG, "Notify -- onNotifySuccess characteristic data : " + HexUtil.formatHexString(characteristic.getValue(), true));
                                            ...
                                            public void onCharacteristicChanged(byte[] data) {
                                                runOnUiThread(new Runnable() {
                                                    @Override
                                                    public void run() {
                                                        Log.e(TAG, "Notify -- onCharacteristicChanged() characteristic data : " + HexUtil.formatHexString(characteristic.getValue(), true));
